...
def download():
    ...
    if '/folders/' in drive_link:
        ...
        zip_command = f'zip -r {zip_file_name} {temp_folder}'
        ...
        upload_command = f'ossutil cp {zip_file_name} oss://googledrive'
        ...
        output_file = f'{file_id}.downloaded'
        ...
        # 调用 ossutil64 工具上传文件
        upload_command = f'ossutil cp {new_file_name} oss://googledrive'
